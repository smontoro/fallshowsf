...
while (have_posts()) :
    ...
    <section id="about" class="container page-padding">
        ...
        <div id="about2">
            ...
            <div class="row about-gala">
                <div class="col-sm-12">
                    <h2><?php echo $gala_committee_year; ?></h2>
                    <hr>
            ...
            <div class="row about-past-show-chairs">
                <div class="col-sm-12">
                    <h2><?php echo $past_show_chairs_title; ?></h2>
                    <hr>
            ...
            <div class="row about-office">
                <div class="col-sm-12">
                    <h2><?php echo $office_info_title; ?></h2>
                    <hr>
